import { makeDb, launchSignedIn, signIn, sleep, shot, newId } from "./md-mockdb.mjs";
...
const { browser, page } = await launchSignedIn(db, { base: BASE, profile: "profile-md-receipts" });
try {
  ...
  await page.screenshot({ path: new URL("md-out/receipts-compact-3302.png", import.meta.url).pathname });
  ...
  await page.screenshot({ path: new URL("md-out/receipts-details-open-3302.png", import.meta.url).pathname });
  await clickInCard(page, "SFX-4402119", "Details");
  await sleep(200);
  ...
  await page.screenshot({ path: new URL("md-out/receipts-to-pay-3302.png", import.meta.url).pathname });
  ...
  await page.screenshot({ path: new URL("md-out/receipts-link-banner-3302.png", import.meta.url).pathname });
  ...
  await page.screenshot({ path: new URL("md-out/invoices-to-receive-3302.png", import.meta.url).pathname });
  ...
  await page.screenshot({ path: new URL("md-out/receipts-link-banner-3302-four.png", import.meta.url).pathname });
  ...
  await page.evaluate(() => [...document.querySelectorAll("main div.rounded-xl")].find((d) => d.innerText.includes("your suppliers")).scrollIntoView());
  await page.screenshot({ path: new URL("md-out/receipts-link-banner-3302-one.png", import.meta.url).pathname });
