...
db.tables.invoice_payments = [{ id: newId(), user_id: "x", invoice_id: I3, date: todayISO(), amount: 10, method: "bank", note: "" }];
db.allowDelete = ["invoice_payments"]; db.tables.credit_notes = []; db.tables.invoice_reminders_sent = [];
db.tables.receipts = [{ id: newId(), user_id: "x", document_type: "invoice", paid: false, needs_review: false, due_date: todayISO(), date: todayISO(), amount: 10, vat_amount: 2, vendor: "Supplier", category: "Materials" }];
