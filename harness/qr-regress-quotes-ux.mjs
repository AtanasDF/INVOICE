...
try {
  ...
  await page.screenshot({ path: "/private/tmp/claude-501/-Users-nasko-Desktop-MM-INVOICES-AUTO/85090693-d203-4a4e-be6a-5911529c13ff/scratchpad/qr/regress-qux-ux-send-whatsapp.png" });
  await tab(page, "Text");
  await sleep(150);
  await page.evaluate(() => document.getElementById("send-quote").scrollIntoView());
  await page.screenshot({ path: "/private/tmp/claude-501/-Users-nasko-Desktop-MM-INVOICES-AUTO/85090693-d203-4a4e-be6a-5911529c13ff/scratchpad/qr/regress-qux-ux-send-text.png" });
  await tab(page, "PDF");
  await sleep(150);
  card = await sendCard(page);
