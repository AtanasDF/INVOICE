...
SUITES=(
  test-tax-rules test-reminder-clock test-money-edges test-money-combined test-vat-boundaries test-vat-cash-basis test-pdf-pages test-next-number test-dates test-vat-pennies test-vat-from-rate test-address-words test-feedback-email test-feedback-inbox
