...
SUITES=(
  ...
  test-inbox-worker test-inbox-ingest test-quote-vat-snapshot test-settings-save test-vat-rate-scan test-feedback test-feedback-page test-first-page test-sign-up test-plain-dates test-neutral test-plain-words test-multi-docs test-company test-copy-document test-send-document test-logo test-public-logo test-site-name test-source-text test-address-stubbed test-public-request
)
...
DEV_SERVER=(test-check-company test-inbox-ingest test-feedback test-send-document test-public-logo test-address-stubbed test-public-request)
