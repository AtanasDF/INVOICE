...
const NO_TIP = {
  ...
  "accessibility": "a statement, read once, by somebody who came looking for it",
  "help": "the page is nothing but explanation; a note on top of it would be explaining the explaining",
