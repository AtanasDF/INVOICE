...
// opened in the phone's Messages or WhatsApp to send. An invoice's private
// link goes into "Job done" only when asked for, so opening the page never
// makes one.
