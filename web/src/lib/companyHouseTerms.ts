// Companies House's own wording for its coded values, taken from
// github.com/companieshouse/api-enumerations (constants.yml, psc_descriptions.yml).
// Server-side only: the SIC table alone is ~1,200 entries and has no business
// in a phone's download.
...
export const COMPANY_BIRTH: Record<string, string> = {
...
export const OFFICER_ROLE: Record<string, string> = {
...
export const INSOLVENCY_CASE: Record<string, string> = {
  ...
  "foreign-insolvency": "Overseas Winding Up",
...
export const INSOLVENCY_DATE: Record<string, string> = {
...
export const PSC_STATEMENT: Record<string, string> = {
